...
namespace GradeBook
{
    ...
    public class Book : NamedObject
    {
        ...
        // the name argument passed to Book on init is also being passed to the base class (NamedObject)
        ...
        //          - treated as static members of the class, meaning has to be accessed by the class itself, not the instance, ie. Book.CATEGORY
